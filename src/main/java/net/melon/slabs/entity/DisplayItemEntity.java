...
public class DisplayItemEntity extends ItemEntity{
   ...
   @Override
   public boolean saveSelfToTag(CompoundTag tag) {return false;}
   @Override
   public boolean saveToTag(CompoundTag tag) {return false;}
   @Override
   public void readCustomDataFromTag(CompoundTag tag) {
      System.out.println("displau red datas");
      this.remove();
   }

   @Override
   public void fromTag(CompoundTag tag) {
      System.out.println("displau red datas2");
      this.remove();
   }
